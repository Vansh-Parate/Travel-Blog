...
export default function TravelStory() {
  ...
  if (!story) return <p className="text-center text-xl sm:text-2xl mt-8 sm:mt-12">Story not found</p>;


  return (
    <div className="min-h-screen py-6 sm:py-8 lg:py-12 bg-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-center mb-6 sm:mb-8">
          {story.title}
        </h2>
      ...
      {/* Full-width Carousel */}
      {story.images &&
      <Carousel showThumbs={false} autoPlay infiniteLoop className="mb-8 sm:mb-12">
        {story.images?.map((image, idx) => (
          <div key={idx}>
            <img src={image} alt={`Slide ${idx}`} className="w-full h-48 sm:h-64 md:h-80 lg:h-96 xl:h-[40rem] object-cover" />
          </div>
        ))}
      </Carousel>
}
...
{/* Story Content */}
{/* Story Content */}
<div className="bg-gradient-to-b from-white to-gray-100 p-4 sm:p-6 lg:p-8 rounded-lg shadow-xl transition-all duration-300 hover:shadow-2xl">
  <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-6 border-b-2 border-gray-300 pb-2">
    Story Details
  </h3>
  
  {/* Story Content */}
  <p className="text-gray-600 leading-relaxed mb-4 sm:mb-6 text-base sm:text-lg animate-fadeIn">
    {story.content}
  </p>

  {/* Date */}
  <div className="text-gray-500 text-xs sm:text-sm mb-4 sm:mb-6 italic">
    Published on: {story.date}
  </div>
  <hr className="border-t border-gray-300 mb-6 sm:mb-8" />
  {/* Our Experience Section */}
  <div className="mt-8 sm:mt-12">
    <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-4 sm:mb-6 flex items-center animate-slideInLeft">
      <span className="mr-2 sm:mr-3 text-blue-500">
  ...
  <div className="mt-8 sm:mt-12">
    <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-4 sm:mb-6 flex items-center animate-slideInRight">
      <span className="mr-2 sm:mr-3 text-green-500">
  ...
  <div className="mt-8 sm:mt-12">
    <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-4 sm:mb-6 flex items-center animate-slideInUp">
      <span className="mr-2 sm:mr-3 text-red-500">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    ...
    <p className="text-gray-700 leading-relaxed text-base sm:text-lg">
      {story.avoid}
        ...
        <div className="mt-6 text-center">
          <Link to="/" className="text-blue-500 hover:text-blue-700 transition-colors duration-200 text-sm sm:text-base">
