...
//created blog data for conveiniency
  ...
  if (!blog) {
    return <h2 className="text-center text-xl sm:text-2xl mt-8 sm:mt-12">Destination not found</h2>
  }
  ...
  return (
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
      {/* Title */}
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-center">{title}</h1>
      ...
      {/* Overview Section */}
      <section className="mb-8 sm:mb-12 fade-in">
        <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">Overview</h2>
        <p className="text-base sm:text-lg text-gray-700 leading-relaxed">{blog.description}</p>
      </section>

      {/* Things to Do Section */}
      <section className="mb-8 sm:mb-12 fade-in">
        <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">Things to Do</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          {blog.thingsToDo.map((activity, idx) => (
            <div
              key={idx}
              className="bg-blue-100 p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105"
            >
              <h3 className="text-lg sm:text-xl font-bold text-blue-700 mb-2">Activity {idx + 1}</h3>
      ...
      {/* Travel Tips Section */}
      <section className="mb-8 sm:mb-12 fade-in">
        <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">Travel Tips</h2>
        <div className="flex flex-col space-y-3 sm:space-y-4">
          {blog.travelTips.map((tip, idx) => (
            <div
              key={idx}
              className="bg-green-100 p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105"
            >
              <h3 className="text-lg sm:text-xl font-bold text-green-700 mb-2">Tip {idx + 1}</h3>
      ...
      <section className="mb-8 sm:mb-12 p-4 sm:p-6 rounded-lg bg-purple-100 shadow-lg fade-in">
        <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">Our Experience</h2>
        <p className="text-base sm:text-lg text-gray-700 leading-relaxed">{blog.ourExperience}</p>
      </section>
      <LatestPosts />
    </div>
    <Footer />
